...
let inputAddress='0x0ed1BCc400aCd34593451e76f854992198995f52'
let web3
try{
   web3 = new Web3(new Web3.providers.HttpProvider('http://localhost:7545'));
}catch(err){
  console.log(" web3 provide not set")
...
contractInstance   = new web3.eth.Contract(contract,address)

  contractInstanceObj[counter]=contractInstance
  // console.log(await contractInstance.methods)
  methodNames= Object.keys(contractInstance.methods)

  for(let i=2;i<methodNames.length;i=i+3){

      console.log(methodNames[i-2])

         if(methodNames[i].includes('()')){
      
         contractInstance.methods[methodNames[i]]().call() 
        .then((value)=>console.log(value))
        .catch(err => console.log("can't get the value because contract is not connected to this testing address")) 
         }else{
           console.log("the function have parameter")
         }
      }
...
async function methodfinding(contract,counter){
  ...
  console.log("---------------------------------------------------------------------------")
  contractInstance = new web3.eth.Contract(contract,'0x0ed1BCc400aCd34593451e76f854992198995f52')
...
try{
  let userAbi = {
    ...
    "metadata": "{\"compiler\":{\"version\":\"0.5.16+commit.9c3226ce\"},\"language\":\"Solidity\",\"output\":{\"abi\":[{\"inputs\":[{\"internalType\":\"contract userAbi\",\"name\":\"_userAbi\",\"type\":\"address\"},{\"internalType\":\"contract DappToken\",\"name\":\"_dapptoken\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"constant\":true,\"inputs\":[],\"name\":\"userAbi\",\"outputs\":[{\"internalType\":\"contract userAbi\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"dapptoken\",\"outputs\":[{\"internalType\":\"contract DappToken\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"name\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}],\"devdoc\":{\"methods\":{}},\"userdoc\":{\"methods\":{}}},\"settings\":{\"compilationTarget\":{\"/home/vishnu/defi_tutorial/src/contracts/TokenFarm.sol\":\"TokenFarm\"},\"evmVersion\":\"petersburg\",\"libraries\":{},\"optimizer\":{\"enabled\":false,\"runs\":200},\"remappings\":[]},\"sources\":{\"/home/vishnu/defi_tutorial/src/contracts/userAbi.sol\":{\"keccak256\":\"0xa499778b27d4a0c77a961ed6622441df8adfbc9dc12441dc8f150573fc2918ab\",\"urls\":[\"bzz-raw://1f7778dc92272f74480a1131da78381a366cc7d71117a08861606e8f05e30ff2\",\"dweb:/ipfs/QmPwB3cQR72eEgfxAt5az7RkgP4g6FdPcPvWF2bwe6tGWN\"]},\"/home/vishnu/defi_tutorial/src/contracts/DappToken.sol\":{\"keccak256\":\"0x1338550035d93eb68886e3109f09d018366ba9f60512d3997e4aa8b8d58c6a6c\",\"urls\":[\"bzz-raw://19bb614695694a40343db1301391176addb4fc31f8fac5b76ea2530edf99c787\",\"dweb:/ipfs/QmcDBCPayPczhjvRnQ6fChTRsqQvE7bZkSnfMhXbKJxCuY\"]},\"/home/vishnu/defi_tutorial/src/contracts/TokenFarm.sol\":{\"keccak256\":\"0xece33bacc38a98c81c4429a8588ae13b0207cf2da694dc5ec770b8194d512067\",\"urls\":[\"bzz-raw://3c55de8e3334a6b68cf8e763844f3dc63abc643fbc7e35fc4dd147c7a83bf49a\",\"dweb:/ipfs/QmaqVkmqQEousLqbRj7T1En9fa6ir88wKpcFmg1RatEeZE\"]}},\"version\":1}",
    ...
    "source": "pragma solidity >=0.4.21 <=0.7.2;\n\nimport \"./userAbi.sol\";\n\nimport \"./DappToken.sol\";\n\n\ncontract TokenFarm{\n\n    string public name =\"Dapp token farm\";\n\n    userAbi public userAbi;\n    DappToken public dapptoken;\n\n    constructor(userAbi _userAbi,DappToken _dapptoken) public{\n                 userAbi= _userAbi;\n                 dapptoken= _dapptoken;\n\n    }\n\n}",
    ...
    "ast": {
      ...
      "nodes": [
        ...
        {
          "absolutePath": "/home/vishnu/defi_tutorial/src/contracts/userAbi.sol",
          "file": "./userAbi.sol",
          "id": 421,
        ...
        },
        {
          ...
          "nodes": [
            ...
            },
            {
              ...
              "storageLocation": "default",
              "typeDescriptions": {
                "typeIdentifier": "t_contract$_userAbi_$180",
                "typeString": "contract userAbi"
              },
              "typeName": {
                "contractScope": null,
                "id": 426,
  ...
  arryContracts.push(userAbi);
  arryContracts.push(abi1)
  arryContracts.push(abi2)

  var i;
  for (i = 0; i <arryContracts.length; i++) {
    if (arryContracts[i].networks){
      let networkData=arryContracts[i].networks
      let newtworkId= Object.keys(networkData)
      addr=networkData[newtworkId].address
      contractInitalize(arryContracts[i].abi,addr,i)
    }else{
      methodfinding(arryContracts[i],i)
    }
...
for (const property in contractInstanceObj) {
  ...
  let funArray=[]
    ...
    if(contractInstanceObj[property]._address==inputAddress){
      ...
      let methodNames= Object.keys(contractInstance.methods)
